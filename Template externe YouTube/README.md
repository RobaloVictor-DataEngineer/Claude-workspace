> ⚠️ **Template externe — non utilisé dans mes projets.**
> Ce dossier est un template récupéré depuis une vidéo YouTube (Yass / Communauté IA).
> Il sert de référence/inspiration uniquement. Mon profil personnel a été repris dans le
> `CLAUDE.md` principal à la racine du dossier `Claude`. Ne pas confondre avec mes projets actifs.
