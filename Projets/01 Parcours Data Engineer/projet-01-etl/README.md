...
## Objectif
Construire un pipeline ETL complet de bout en bout : extraire des données (CSV ou API), les transformer avec pandas (nettoyage + jointures), puis les charger dans PostgreSQL.
